    ...
    <div className="bg-black text-white px-6 py-10 md:px-20 lg:px-40">
      ...
      <Section title="Welcome to W567 Game">
        <p>
          ...
          interest in learning more about W567 Game. In today’s digital world,
          people rely heavily on online platforms for entertainment,
      ...
      <Section title="Our Mission">
        <p>
          ...
          offer 100% original, safe, and user-friendly content. We’re committed
          to helping you find genuine gaming resources, updates, and
      ...
      <Section title="What We Do">
        <p>
          ...
          latest updates. Whether you're new to gaming or an experienced player,
          we aim to keep you informed and engaged with fresh content.
        </p>
        <p className="mt-4">
          While gaming is our primary focus, we also share content across other
          categories to provide a broader experience. Visit our{" "}
      ...
      <Section title="Why We Built W567 Game">
        <p>
          ...
          mission is simple: **provide clean, clear, and valuable content** that
          actually helps.
        </p>
      </Section>
      ...
      <Section title="Message from the Admin">
        <p>
          Hi, I’m Soumya — the founder of W567 Game. From my experience online,
          I noticed that most people struggle to find honest information. That’s
          why I created this platform: to offer **100% legit and accurate
          content** that users can trust. It’s my dream to build a trusted
          resource, and I thank you for being part of that journey.
        </p>
      </Section>
      ...
      <Section title="Contact Information">
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <span className="text-green-500 font-semibold">Instagram:</span> Not
            shared
          </li>
        </ul>
        <p className="mt-4">
